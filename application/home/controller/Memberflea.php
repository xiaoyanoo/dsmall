...
class Memberflea extends BaseFleaMember {
    ...
    public function save_goods() {
        ...
        if (request()->isPost()) {
            ...
            $rule = [
                ['goods_name', 'require', lang('store_goods_index_flea_name_null')],
                ['goods_price', 'require', lang('store_goods_index_flea_price_null')]
            ];
    ...
    public function image_upload() {
        ...
        echo $this->fetch($this->template_dir . 'flea_upload_image');
    }
        ...
        if (input('drop') && input('drop') == 'ok' && input('fav_id')) {
            ...
            if (!empty($fav_arr) && is_array($fav_arr)) {
                ...
                foreach ($fav_arr as $fav_id) {
                    if (intval($fav_id) > 0) {
                        if (!$fleafavorites_model->delFleafavorites(intval($fav_id), 'flea')) {
                ...
                if (intval(input('get.fav_id')) > 0) {
                    if (!$fleafavorites_model->delFleafavorites(intval(input('get.fav_id')), 'flea')) {
                        ds_json_encode(10001,lang('flea_favorite_del_fail'));
                    }
        ...
        if (intval(input('fav_id')) > 0) {
            ...
            if (!$check_rss) {
                ...
                $add_rs = $fleafavorites_model->addFleafavorites(array(
                    ...
                    'fav_id' => intval(input('fav_id')), 'fav_type' => 'flea',
                    'fav_time' => time()
                ));
                if (!$add_rs) {
