...
class Membersecurity extends BaseMember {
    ...
    public function send_bind_email() {
        ...
        //验证数据  BEGIN
        $rule = [
            ['email', 'email', lang('please_fill_mailbox_correctly')],
        ];
    ...
    public function modify_pwd() {
        ...
        //验证数据  BEGIN
        $rule = [
            ['password', 'require', lang('please_enter_password_correctly')], ['confirm_password', 'require', lang('please_enter_password_correctly')],
        ];
        $validate = new Validate();
    ...
    public function modify_paypwd() {
        ...
        //验证数据  BEGIN
        $rule = [
            ['password', 'require', lang('please_enter_password_correctly')],
            ['confirm_password', 'require', lang('please_enter_password_correctly')],
        ];
        $validate = new Validate();
        $validate_result = $validate->check($data, $rule);
        if (!$validate_result) {
    ...
    public function modify_mobile() {
        ...
        if (request()->isPost()) {
            ...
            //验证数据  BEGIN
            $rule = [
                ['mobile', 'require', lang('fill_your_phone_number_correctly')], ['vcode', 'require', lang('fill_phone_verification_code_correctly')],
            ];
            $validate = new Validate();
            $validate_result = $validate->check($data, $rule);
            if (!$validate_result) {
    ...
    public function send_modify_mobile() {
        ...
        //验证数据  BEGIN
        $rule = [
            ['mobile', 'require', lang('fill_your_phone_number_correctly')],
        ];
        $validate = new Validate();
