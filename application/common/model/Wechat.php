...
class Wechat extends Model
{
    ...
    public function getWxmemberList() {
        $info = db('member')->where('member_wxinfo is not null')->field('member_name,member_addtime,member_wxunionid,member_wxopenid,member_id')->paginate(8, false, ['query' => request()->param()]);
        $this->page_info = $info;
        return $info->items();
    }
