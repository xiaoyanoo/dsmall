...
class Selleralbum extends BaseSeller {
    ...
    public function album_pic_del() {
        ...
        if ($return) {
            ...
            ds_json_encode(10001,lang('album_class_pic_del_lose'));
        }
    }
    ...
    public function album_pic_watermark() {
        ...
        if ($store_wm_info['swm_image_name'] == '' && $store_wm_info['swm_text'] == '') {
            ds_json_encode(10001,lang('album_class_setting_wm'));
        }
        ...
        ds_json_encode(10000,lang('album_pic_plus_wm_succeed'));
    }
    ...
    public function store_watermark() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                ds_json_encode(10000,lang('store_watermark_congfig_success'));
            } else {
                ds_json_encode(10001,lang('store_watermark_congfig_fail'));
            }
        }
    }
