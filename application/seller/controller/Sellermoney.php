...
class Sellermoney extends BaseSeller {
    ...
    public function withdraw_add() {
        ...
        if (request()->isPost()) {
            $rule = [
                'pdc_amount' => 'require|number|min:0.01|max:' . $store_info['store_avaliable_money'],
            ];
            $msg = [
                'pdc_amount.require' => lang('sellermoney_withdraw_amount_require'),
                'pdc_amount.number' => lang('sellermoney_withdraw_amount_number'),
                'pdc_amount.min' => lang('sellermoney_withdraw_amount_min'),
                'pdc_amount.max' => lang('sellermoney_withdraw_amount_max'),
            ];
            $data=[
