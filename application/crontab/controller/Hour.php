...
class Hour extends BaseCron {
    ...
    public function xs_create() {
        ...
        try {
            ...
            $count = $goods_model->getGoodsOnlineCount(array(),"distinct CONCAT(goods_commonid,',',color_id)");
            echo 'Total:'.$count."\n";
    ...
    public function _xs_update() {
        ...
        try {
            ...
            $count = $goods_model->getGoodsOnlineCount($condition,"distinct CONCAT(goods_commonid,color_id)");
            $fields = "*,CONCAT(goods_commonid,color_id) as nc_distinct";
            for ($i = 0; $i <= $count; $i = $i + $step_num){
