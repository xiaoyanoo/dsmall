...
class Store extends AdminControl {
    ...
    public function store_edit() {
        ...
        if (!request()->isPost()) {
            ...
            //个人注册还是公司注册
            $this->assign('if_company',($joinin_detail['business_licence_address']!=''));
            ...
            $update_array['store_baozhopen'] = trim(input('post.store_baozhopen')); //保证金显示开关
            $update_array['store_baozhrmb'] = trim(input('post.store_baozhrmb')); //新加保证金-金额
...
//            }
    ...
    public function del() {
        ...
        $storeArray = $store_model->field('is_platform_store,store_name')->find($storeId);
