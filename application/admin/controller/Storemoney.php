...
class Storemoney extends AdminControl {
    ...
    public function adjust() {
        if (!(request()->isPost())) {
            ...
            //验证 BEGIN
            $rule = [
                ['seller_id', 'require|number', lang('admin_storemoney_artificial_membernamenull_error').'|'.lang('admin_storemoney_userrecord_error')],
                ['amount', 'require', lang('admin_storemoney_artificial_pricenull_error')],
                ['operatetype', 'require', lang('ds_none_input').lang('admin_storemoney_artificial_operatetype')],
            ];
