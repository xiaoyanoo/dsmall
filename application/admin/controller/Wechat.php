...
class Wechat extends AdminControl {
    ...
    public function menu_edit() {
        ...
        if (!request()->isPost()) {
            ...
            $rule = [
                ['name', 'require', lang('name_can_not_null')],
                ['sort', 'number', lang('sort_error')],
                ['type', 'require', lang('type_can_not_null')],
            ];
            if($menu_type == 'view'){
                $rule[] = ['value', 'require|url', lang('value_can_not_null').'|'.lang('url_error')];
            }
    ...
    public function member() {
        $res = model('wechat')->getWxmemberList();
