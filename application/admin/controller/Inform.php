...
class Inform extends AdminControl
{
    ...
    public function inform_subject_type_add()
    {
        if (!request()->isPost()) {
            ...
            $rule = [
                    ['informtype_name', 'require|max:50|min:1', lang('inform_type_null')],
                    ['informtype_desc', 'require|max:50|min:1', lang('inform_type_desc_null')]
            ];
    ...
    public function inform_subject_add() {
        if (!request()->isPost()) {
            ...
            $rule = [
                    ['informsubject_type_name', 'require|min:1|max:50', lang('inform_subject_null')],
                    ['informsubject_content', 'require|min:1|max:50', lang('inform_content_null')],
                    ['informsubject_type_id', 'require|min:1|max:50', lang('param_error')]
            ];
