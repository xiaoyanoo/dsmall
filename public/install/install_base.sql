...
CREATE TABLE `#__goodscommon` (
  ...
  `is_platform_store` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为平台自营',
  `goods_mgdiscount` text COMMENT '序列化会员等级折扣(商品)',
`inviter_ratio_1` DECIMAL( 3, 2 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT  '一级分销比例' ,
`inviter_ratio_2` DECIMAL( 3, 2 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT  '二级分销比例' ,
`inviter_ratio_3` DECIMAL( 3, 2 ) UNSIGNED NOT NULL DEFAULT '0' COMMENT  '三级分销比例' ,
...
(7, 'site_mobile_logo', 'site_mobile_logo.jpg', '默认商城手机端logo'),
...
(134, 'consult_prompt', '<p>因厂家更改商品包装、场地、附配件等不做提前通知，且每位咨询者购买、提问时间等不同。为此，客服给到的回复仅对提问者3天内有效，其他网友仅供参考！给您带来的不变还请谅解，谢谢！</p>', '解释,备注'),
...
(11, 3, '首页-楼层1底部广告', '', '5a435adbf392f.png', 1514304000, 1545840000, 0, 1, 0, NULL),
(12, 4, '首页-楼层2底部广告', '', '5a435b549421e.png', 1514304000, 1545840000, 0, 1, 0, NULL),
(13, 5, '首页-楼层3底部广告', '', '5a435b7d9f595.png', 1514304000, 1545840000, 0, 1, 0, NULL),
(14, 6, '首页-楼层4底部广告', '', '5a435b916f3dd.png', 1514304000, 1545840000, 0, 1, 0, NULL),
(15, 7, '首页-楼层5底部广告', '', '5a435b9bdd15c.jpg', 1514304000, 1545840000, 0, 1, 0, NULL),
(16, 8, '首页-楼层1侧边广告', '', '5a436c7cb280d.jpg', 1514304000, 1545840000, 0, 1, 0, NULL),
(17, 9, '首页-楼层2侧边广告', '', '5a436c8b76e45.jpg', 1514304000, 1545840000, 0, 1, 0, NULL),
(18, 10, '首页-楼层3侧边广告', '', '5a436c953dab3.png', 1514304000, 1545840000, 0, 1, 0, NULL),
(19, 11, '首页-楼层4侧边广告', '', '5a436ca09a8f4.jpg', 1514304000, 1545840000, 0, 1, 0, NULL),
(20, 12, '首页-楼层5侧边广告', '', '5a436cae1b5b3.png', 1514304000, 1545840000, 0, 1, 0, NULL),
